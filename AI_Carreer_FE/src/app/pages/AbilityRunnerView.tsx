...
export function AbilityRunnerView() {
  ...
  const handleSubmit = () => {
    ...
    questions.forEach((q) => {
      ...
      if (!key) return;
      const valueKey = `value_${key}` as "value_a" | "value_b" | "value_c" | "value_d";
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="mt-4 space-y-2 text-slate-700">
                  ...
                  <div>
                    <span className="font-semibold">Thời gian:</span> 0:20:0
                  </div>
                  <div className="pt-2">
